...
/** Progreso del recorrido: barra (scroll-driven o fallback JS) + pasos. */
export default function StoryProgress({ stages, active, onJump }: Props) {
  ...
  return (
    <div className="w-full">
      ...
      <ol className="mt-3 flex flex-wrap gap-2" aria-label="Etapas de la historia">
        {stages.map((stage, i) => {
          ...
          return (
            <li key={stage.id}>
              <button
                ...
                style={{
                  borderColor: isActive ? colorFor(stage.colorToken) : "rgba(255,255,255,0.2)",
                  background: isActive ? colorFor(stage.colorToken) : "transparent",
